...
import com.kok.sport.utils.db.MysqlUpdateUtil;
...
@Api(value = "数据添加接口api", tags = "数据edit编辑 接口api")
@RestController
@SuppressWarnings("all")
public class ApiController4edit {
//	static org.apache.logging.log4j.Logger logger = LogManager.getLogger(ApiController.class);
	...
	public Object editData() throws Exception {
		MysqlUpdateUtil.sqlSessionFactory=sqlSessionFactory;
		Map m = RequestUtil.getMap(req);
		return MysqlUpdateUtil.update(sqlSessionFactory, m);

	}

	// 核心接口
	@ApiOperation(value = "参数为json模式")
	@GetMapping("/editDataJson")
	public Object editDataJson(String json) throws Exception {
	...
	// 多语句 高级接口
	@ApiOperation(value = "批量模式")
	@GetMapping("/editDataMulti")
	public Object editDataMulti(String jsonArray) throws Exception {
		// String ql = req.getParameter("ql");
		return MysqlUpdateUtil.updateMulti(jsonArray, sqlSessionFactory);
